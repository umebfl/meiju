        ...
        return (
            <View style={styles.view}>
                <Video
                    ...
                    style={{width: 400, height: 200,backgroundColor:'black'}}
                    allowsExternalPlayback={false} // 不允许导出 或 其他播放器播放
                    paused = {false} // 控制视频是否暂停
                    resizeMode='contain' // 视频拉伸,平台:Android ExoPlayer, Android MediaPlayer, iOS, Windows UWP
                    posterResizeMode='cover' // 平台: 全平台
                    volume={0}
                />
            </View>
        )
